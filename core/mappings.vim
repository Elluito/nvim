...
" Turn current word to bold
inoremap <c-b> <Esc>viw di\textbf{<Del><Esc>pea}

" Turn current word to italic
inoremap <c-r> <Esc>viw di\textit{<Del><Esc>pea}
...
"save  the buffer but do not quits
