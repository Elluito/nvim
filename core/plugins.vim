...
"Here some things ifr faster LATEX TYPING taken from here
...
"}}
"{{ Remap para compilar SumatraPDF
call utils#Cabbrev('vpdf', 'VimtexView')
call utils#Cabbrev('cpdf','VimtexCompile')
call utils#Cabbrev('copdf','VimtexCompileOutput')
call utils#Cabbrev('scpdf','VimtexStop')
call utils#Cabbrev('tocpdf','VimtexTocOpen')
...
call utils#Cabbrev('focus', 'Iawriter')
let g:goyo_width = '70%'
